...
**Source**: https://github.com/nixawk/pentest-wiki/blob/master/4.Post-Exploitation/Windows_ActiveDirectory/Hacking_Windows_Active_Directory.md
...
define('AUTH_SALT',        'HE<}>b.$S.GKNy@cUXCezBJmGkVM~GO/R%jB}6y~@HY3 Wxx+,]mkpbEjC|GQ73!');
